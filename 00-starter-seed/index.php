        ...
        <div class="container">
            <div class="login-page clearfix">
              ...
              <div class="login-box auth0-box before">
                ...
                <h3>Auth0 Example to CovidBlog</h3>
                <p>We are in trials linking our webapp for a One stop Authentification and Safety</p>
                <a id="qsLoginBtn" class="btn btn-primary btn-lg btn-login btn-block" href="login.php" style="width: 100%;">Sign In</a>
              </div>
              <?php else: ?>
